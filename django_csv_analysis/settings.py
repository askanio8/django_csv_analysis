"""Django settings for django_csv_analysis project.
...
ALLOWED_HOSTS = [*env.list("DJANGO__ALLOWED_HOSTS", default=[]), "localhost"]
...
ROOT_URLCONF = "django_csv_analysis.urls"
...
WSGI_APPLICATION = "django_csv_analysis.wsgi.application"
